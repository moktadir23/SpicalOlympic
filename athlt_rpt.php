            ...
            <div class="row clearfix">
              ...
              while($get_listitem = mysqli_fetch_array($get_result))
              {
                ?>
                                        ...
                                        <td><?php echo $get_listitem["b_certicicate"]; ?></td>
                                        <td><?php echo $get_listitem["d_type"]; ?></td>
                                        ...
                                        <td><?php echo $get_listitem["reg_year"]; ?></td>
                                        <td><?php echo $get_listitem["guardian"]; ?></td>
                                        <td><?php echo $get_listitem["relation"]; ?></td>
                                        <td><?php echo $get_listitem["g_cell"]; ?></td>
